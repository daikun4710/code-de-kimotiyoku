...
const promise = new Promise((resolve) => {
    ...
    const dayofweekId = document.getElementById('dayofweek');
    //曜日によって変更する位置が変更される
    ...
    for (let i = 0; i < col; i++) {
        ...
        contentCol.id = 'day' + i;
        contentCol.setAttribute('class', 'dayText');
        contentCol.innerHTML = dayArr[i];
        contentCol.style.width = '100px';
        contentCol.style.height = '30px';
        contentCol.style.marginRight = '5px';
        contentCol.style.fontWeight = '500';
        // contentCol.style.marginBottom = '10px';
        // contentCol.style.textAlign = 'center';
        dayofweekId.appendChild(contentCol);
    }
